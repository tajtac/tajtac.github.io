...
class SlideMovingCameraScene(MovingCameraScene):
    offset=0.0
    breaks=[0]
    video_slides_dir="./video_slides"
    def setup(self):
        super(SlideMovingCameraScene, self).setup()
        self.breaks=[0]
    ...
    def tear_down(self):
        super(SlideMovingCameraScene, self).tear_down()
        self.save_times()

    def print_end_message(self):
        super(SlideMovingCameraScene, self).print_end_message()
        self.copy_files()

class SlideThreeDScene(ThreeDScene):
    offset=0.0
    breaks=[0]
    video_slides_dir="./video_slides"
    def setup(self):
        super(SlideThreeDScene, self).setup()
        self.breaks=[0]
    ...
    def tear_down(self):
        super(SlideThreeDScene, self).tear_down()
        self.save_times()

    def print_end_message(self):
        super(SlideThreeDScene, self).print_end_message()
        self.copy_files()